...
class Trainer():
    def __init__(self,args):
        ...
        # wandb
        self.run = wandb.init(project="DLP_homework4", entity="kuolunwang")
        config = wandb.config
        ...
        self.file_name ="{0}_{1}_{2}_{3}_{4}_{5}_{6}".format(args.network, text, finetune, we, args.batch_size, args.epochs, args.learning_rate)
        ...
        # model 
        self.model = get_model(args.network, 5, args.feature_extract, args.pretrained)
        ...
        # criterion
        self.criterion = nn.CrossEntropyLoss(weight=weight_loss) if args.weight_loss else nn.CrossEntropyLoss()
