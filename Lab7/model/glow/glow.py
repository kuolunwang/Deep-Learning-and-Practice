...
from model.glow.act_norm import ActNorm
from model.glow.coupling import Coupling
from model.glow.inv_conv import InvConv


class Glow(nn.Module):

    def __init__(self, num_channels, num_levels, num_steps, n_class, img_size, mode='sketch'):
